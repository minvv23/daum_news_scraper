...
if __name__ == '__main__':
    print('Insert the initial date (ex. 20190305) :')
    start = int(input())
    print('Insert the last date (ex. 20191023) :')
    end = int(input())
    print('Insert the query (ex.병원) :')
    query = str(input())
    print('Insert the press name (ex. 경향신문, 한겨레, 조선일보, 중앙일보, 동아일보, 국민일보, 한국일보, 한국경제, 매일경제) :')
    press_name = str(input())
    hunnae_scraper(start, end, query, press_name)